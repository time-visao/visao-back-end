...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.ReportDownloadsApi = factory(root.CyberSource.ApiClient, root.CyberSource.ReportingV3NotificationofChangesGet400Response);
  }
  ...
  var exports = function(configObject, apiClient) {
     ...
     * @param {Date} reportDate Valid date on which to download the report in **ISO 8601 format** Please refer the following link to know more about ISO 8601 format. - https://xml2rfc.tools.ietf.org/public/rfc/html/rfc3339.html#anchor14   **Example date format:**   - yyyy-MM-dd 
    ...
    this.downloadReport = function(reportDate, reportName, opts, callback) {
      ...
      var accepts = ['application/xml', 'test/csv'];
      var returnType = null;
