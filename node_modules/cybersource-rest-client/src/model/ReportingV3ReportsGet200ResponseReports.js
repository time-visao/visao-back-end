...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.ReportingV3ReportsGet200ResponseReports = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The ReportingV3ReportsGet200ResponseReports model module.
   * @module model/ReportingV3ReportsGet200ResponseReports
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>ReportingV3ReportsGet200ResponseReports</code>.
   * Report Search Result Bean
   * @alias module:model/ReportingV3ReportsGet200ResponseReports
   * @class
   */
  ...
  /**
   * Constructs a <code>ReportingV3ReportsGet200ResponseReports</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ReportingV3ReportsGet200ResponseReports} obj Optional instance to populate.
   * @return {module:model/ReportingV3ReportsGet200ResponseReports} The populated <code>ReportingV3ReportsGet200ResponseReports</code> instance.
   */
   ...
   * @member {module:model/ReportingV3ReportsGet200ResponseReports.ReportMimeTypeEnum} reportMimeType
   */
  exports.prototype['reportMimeType'] = undefined;
  /**
   * Frequency of the report to get generated
   * @member {module:model/ReportingV3ReportsGet200ResponseReports.ReportFrequencyEnum} reportFrequency
   */
  exports.prototype['reportFrequency'] = undefined;
  /**
   * Status of the report
   * @member {module:model/ReportingV3ReportsGet200ResponseReports.StatusEnum} status
   */
