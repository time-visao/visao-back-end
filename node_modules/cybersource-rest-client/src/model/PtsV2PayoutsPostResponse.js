...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PtsV2PaymentsPost201ResponseClientReferenceInformation', 'model/Ptsv2payoutsMerchantInformation', 'model/Ptsv2payoutsOrderInformation', 'model/Ptsv2payoutsPaymentInformation', 'model/Ptsv2payoutsProcessingInformation', 'model/Ptsv2payoutsRecipientInformation', 'model/Ptsv2payoutsSenderInformation'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PtsV2PaymentsPost201ResponseClientReferenceInformation'), require('./Ptsv2payoutsMerchantInformation'), require('./Ptsv2payoutsOrderInformation'), require('./Ptsv2payoutsPaymentInformation'), require('./Ptsv2payoutsProcessingInformation'), require('./Ptsv2payoutsRecipientInformation'), require('./Ptsv2payoutsSenderInformation'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.PtsV2PayoutsPostResponse = factory(root.CyberSource.ApiClient, root.CyberSource.PtsV2PaymentsPost201ResponseClientReferenceInformation, root.CyberSource.Ptsv2payoutsMerchantInformation, root.CyberSource.Ptsv2payoutsOrderInformation, root.CyberSource.Ptsv2payoutsPaymentInformation, root.CyberSource.Ptsv2payoutsProcessingInformation, root.CyberSource.Ptsv2payoutsRecipientInformation, root.CyberSource.Ptsv2payoutsSenderInformation);
  }
}(this, function(ApiClient, PtsV2PaymentsPost201ResponseClientReferenceInformation, Ptsv2payoutsMerchantInformation, Ptsv2payoutsOrderInformation, Ptsv2payoutsPaymentInformation, Ptsv2payoutsProcessingInformation, Ptsv2payoutsRecipientInformation, Ptsv2payoutsSenderInformation) {
  'use strict';
  ...
  /**
   * The PtsV2PayoutsPostResponse model module.
   * @module model/PtsV2PayoutsPostResponse
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PtsV2PayoutsPostResponse</code>.
   * @alias module:model/PtsV2PayoutsPostResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PtsV2PayoutsPostResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PtsV2PayoutsPostResponse} obj Optional instance to populate.
   * @return {module:model/PtsV2PayoutsPostResponse} The populated <code>PtsV2PayoutsPostResponse</code> instance.
   */
