...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PtsV2PaymentsPost201ResponseClientReferenceInformation', 'model/PtsV2PaymentsReversalsPost201ResponseLinks', 'model/PtsV2PaymentsVoidsPost201ResponseVoidAmountDetails'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PtsV2PaymentsPost201ResponseClientReferenceInformation'), require('./PtsV2PaymentsReversalsPost201ResponseLinks'), require('./PtsV2PaymentsVoidsPost201ResponseVoidAmountDetails'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.PtsV2PaymentsVoidsPost201Response = factory(root.CyberSource.ApiClient, root.CyberSource.PtsV2PaymentsPost201ResponseClientReferenceInformation, root.CyberSource.PtsV2PaymentsReversalsPost201ResponseLinks, root.CyberSource.PtsV2PaymentsVoidsPost201ResponseVoidAmountDetails);
  }
}(this, function(ApiClient, PtsV2PaymentsPost201ResponseClientReferenceInformation, PtsV2PaymentsReversalsPost201ResponseLinks, PtsV2PaymentsVoidsPost201ResponseVoidAmountDetails) {
  'use strict';
