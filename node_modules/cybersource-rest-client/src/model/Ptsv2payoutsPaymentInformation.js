...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Ptsv2payoutsPaymentInformationCard'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Ptsv2payoutsPaymentInformationCard'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.Ptsv2payoutsPaymentInformation = factory(root.CyberSource.ApiClient, root.CyberSource.Ptsv2payoutsPaymentInformationCard);
  }
}(this, function(ApiClient, Ptsv2payoutsPaymentInformationCard) {
  'use strict';
