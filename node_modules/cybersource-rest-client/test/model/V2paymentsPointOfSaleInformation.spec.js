...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V2paymentsPointOfSaleInformation();
  });
  ...
  describe('V2paymentsPointOfSaleInformation', function() {
    it('should create an instance of V2paymentsPointOfSaleInformation', function() {
      // uncomment below and update the code to test V2paymentsPointOfSaleInformation
      //var instane = new CyberSource.V2paymentsPointOfSaleInformation();
      //expect(instance).to.be.a(CyberSource.V2paymentsPointOfSaleInformation);
    });
