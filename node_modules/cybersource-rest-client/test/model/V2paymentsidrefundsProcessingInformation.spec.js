...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V2paymentsidrefundsProcessingInformation();
  });
  ...
  describe('V2paymentsidrefundsProcessingInformation', function() {
    it('should create an instance of V2paymentsidrefundsProcessingInformation', function() {
      // uncomment below and update the code to test V2paymentsidrefundsProcessingInformation
      //var instane = new CyberSource.V2paymentsidrefundsProcessingInformation();
      //expect(instance).to.be.a(CyberSource.V2paymentsidrefundsProcessingInformation);
    });
