...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V2paymentsidcapturesOrderInformation();
  });
  ...
  describe('V2paymentsidcapturesOrderInformation', function() {
    it('should create an instance of V2paymentsidcapturesOrderInformation', function() {
      // uncomment below and update the code to test V2paymentsidcapturesOrderInformation
      //var instane = new CyberSource.V2paymentsidcapturesOrderInformation();
      //expect(instance).to.be.a(CyberSource.V2paymentsidcapturesOrderInformation);
    });
