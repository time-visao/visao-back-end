...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V2payoutsProcessingInformation();
  });
  ...
  describe('V2payoutsProcessingInformation', function() {
    it('should create an instance of V2payoutsProcessingInformation', function() {
      // uncomment below and update the code to test V2payoutsProcessingInformation
      //var instane = new CyberSource.V2payoutsProcessingInformation();
      //expect(instance).to.be.a(CyberSource.V2payoutsProcessingInformation);
    });
