...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V2payoutsPaymentInformationCard();
  });
  ...
  describe('V2payoutsPaymentInformationCard', function() {
    it('should create an instance of V2payoutsPaymentInformationCard', function() {
      // uncomment below and update the code to test V2payoutsPaymentInformationCard
      //var instane = new CyberSource.V2payoutsPaymentInformationCard();
      //expect(instance).to.be.a(CyberSource.V2payoutsPaymentInformationCard);
    });
