...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V2paymentsOrderInformationShipTo();
  });
  ...
  describe('V2paymentsOrderInformationShipTo', function() {
    it('should create an instance of V2paymentsOrderInformationShipTo', function() {
      // uncomment below and update the code to test V2paymentsOrderInformationShipTo
      //var instane = new CyberSource.V2paymentsOrderInformationShipTo();
      //expect(instance).to.be.a(CyberSource.V2paymentsOrderInformationShipTo);
    });
