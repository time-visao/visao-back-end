...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse2002PaymentInformationTokenizedCard();
  });
  ...
  describe('InlineResponse2002PaymentInformationTokenizedCard', function() {
    it('should create an instance of InlineResponse2002PaymentInformationTokenizedCard', function() {
      // uncomment below and update the code to test InlineResponse2002PaymentInformationTokenizedCard
      //var instane = new CyberSource.InlineResponse2002PaymentInformationTokenizedCard();
      //expect(instance).to.be.a(CyberSource.InlineResponse2002PaymentInformationTokenizedCard);
    });
