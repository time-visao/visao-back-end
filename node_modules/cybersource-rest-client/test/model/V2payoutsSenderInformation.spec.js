...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V2payoutsSenderInformation();
  });
  ...
  describe('V2payoutsSenderInformation', function() {
    it('should create an instance of V2payoutsSenderInformation', function() {
      // uncomment below and update the code to test V2payoutsSenderInformation
      //var instane = new CyberSource.V2payoutsSenderInformation();
      //expect(instance).to.be.a(CyberSource.V2payoutsSenderInformation);
    });
