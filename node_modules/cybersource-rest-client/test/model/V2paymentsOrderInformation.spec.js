...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V2paymentsOrderInformation();
  });
  ...
  describe('V2paymentsOrderInformation', function() {
    it('should create an instance of V2paymentsOrderInformation', function() {
      // uncomment below and update the code to test V2paymentsOrderInformation
      //var instane = new CyberSource.V2paymentsOrderInformation();
      //expect(instance).to.be.a(CyberSource.V2paymentsOrderInformation);
    });
