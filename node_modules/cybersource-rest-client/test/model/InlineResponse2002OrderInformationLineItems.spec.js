...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse2002OrderInformationLineItems();
  });
  ...
  describe('InlineResponse2002OrderInformationLineItems', function() {
    it('should create an instance of InlineResponse2002OrderInformationLineItems', function() {
      // uncomment below and update the code to test InlineResponse2002OrderInformationLineItems
      //var instane = new CyberSource.InlineResponse2002OrderInformationLineItems();
      //expect(instance).to.be.a(CyberSource.InlineResponse2002OrderInformationLineItems);
    });
