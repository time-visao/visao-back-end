...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse2004OrderInformationInvoiceDetails();
  });
  ...
  describe('InlineResponse2004OrderInformationInvoiceDetails', function() {
    it('should create an instance of InlineResponse2004OrderInformationInvoiceDetails', function() {
      // uncomment below and update the code to test InlineResponse2004OrderInformationInvoiceDetails
      //var instane = new CyberSource.InlineResponse2004OrderInformationInvoiceDetails();
      //expect(instance).to.be.a(CyberSource.InlineResponse2004OrderInformationInvoiceDetails);
    });
