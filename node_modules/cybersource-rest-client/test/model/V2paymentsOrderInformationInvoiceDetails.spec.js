...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V2paymentsOrderInformationInvoiceDetails();
  });
  ...
  describe('V2paymentsOrderInformationInvoiceDetails', function() {
    it('should create an instance of V2paymentsOrderInformationInvoiceDetails', function() {
      // uncomment below and update the code to test V2paymentsOrderInformationInvoiceDetails
      //var instane = new CyberSource.V2paymentsOrderInformationInvoiceDetails();
      //expect(instance).to.be.a(CyberSource.V2paymentsOrderInformationInvoiceDetails);
    });
