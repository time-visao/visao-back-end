...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V2paymentsidcapturesMerchantInformation();
  });
  ...
  describe('V2paymentsidcapturesMerchantInformation', function() {
    it('should create an instance of V2paymentsidcapturesMerchantInformation', function() {
      // uncomment below and update the code to test V2paymentsidcapturesMerchantInformation
      //var instane = new CyberSource.V2paymentsidcapturesMerchantInformation();
      //expect(instance).to.be.a(CyberSource.V2paymentsidcapturesMerchantInformation);
    });
