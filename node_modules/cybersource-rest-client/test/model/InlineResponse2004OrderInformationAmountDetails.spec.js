...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse2004OrderInformationAmountDetails();
  });
  ...
  describe('InlineResponse2004OrderInformationAmountDetails', function() {
    it('should create an instance of InlineResponse2004OrderInformationAmountDetails', function() {
      // uncomment below and update the code to test InlineResponse2004OrderInformationAmountDetails
      //var instane = new CyberSource.InlineResponse2004OrderInformationAmountDetails();
      //expect(instance).to.be.a(CyberSource.InlineResponse2004OrderInformationAmountDetails);
    });
