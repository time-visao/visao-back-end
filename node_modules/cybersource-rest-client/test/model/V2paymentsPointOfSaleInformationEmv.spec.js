...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V2paymentsPointOfSaleInformationEmv();
  });
  ...
  describe('V2paymentsPointOfSaleInformationEmv', function() {
    it('should create an instance of V2paymentsPointOfSaleInformationEmv', function() {
      // uncomment below and update the code to test V2paymentsPointOfSaleInformationEmv
      //var instane = new CyberSource.V2paymentsPointOfSaleInformationEmv();
      //expect(instance).to.be.a(CyberSource.V2paymentsPointOfSaleInformationEmv);
    });
