...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V2paymentsidrefundsOrderInformationLineItems();
  });
  ...
  describe('V2paymentsidrefundsOrderInformationLineItems', function() {
    it('should create an instance of V2paymentsidrefundsOrderInformationLineItems', function() {
      // uncomment below and update the code to test V2paymentsidrefundsOrderInformationLineItems
      //var instane = new CyberSource.V2paymentsidrefundsOrderInformationLineItems();
      //expect(instance).to.be.a(CyberSource.V2paymentsidrefundsOrderInformationLineItems);
    });
