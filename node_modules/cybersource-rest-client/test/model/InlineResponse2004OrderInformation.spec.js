...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse2004OrderInformation();
  });
  ...
  describe('InlineResponse2004OrderInformation', function() {
    it('should create an instance of InlineResponse2004OrderInformation', function() {
      // uncomment below and update the code to test InlineResponse2004OrderInformation
      //var instane = new CyberSource.InlineResponse2004OrderInformation();
      //expect(instance).to.be.a(CyberSource.InlineResponse2004OrderInformation);
    });
