...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse201ProcessorInformation();
  });
  ...
  describe('InlineResponse201ProcessorInformation', function() {
    it('should create an instance of InlineResponse201ProcessorInformation', function() {
      // uncomment below and update the code to test InlineResponse201ProcessorInformation
      //var instane = new CyberSource.InlineResponse201ProcessorInformation();
      //expect(instance).to.be.a(CyberSource.InlineResponse201ProcessorInformation);
    });
