...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PaymentinstrumentsInstrumentIdentifier();
  });
  ...
  describe('PaymentinstrumentsInstrumentIdentifier', function() {
    it('should create an instance of PaymentinstrumentsInstrumentIdentifier', function() {
      // uncomment below and update the code to test PaymentinstrumentsInstrumentIdentifier
      //var instane = new CyberSource.PaymentinstrumentsInstrumentIdentifier();
      //expect(instance).to.be.a(CyberSource.PaymentinstrumentsInstrumentIdentifier);
    });
