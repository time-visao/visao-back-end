...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse2002OrderInformationShipTo();
  });
  ...
  describe('InlineResponse2002OrderInformationShipTo', function() {
    it('should create an instance of InlineResponse2002OrderInformationShipTo', function() {
      // uncomment below and update the code to test InlineResponse2002OrderInformationShipTo
      //var instane = new CyberSource.InlineResponse2002OrderInformationShipTo();
      //expect(instance).to.be.a(CyberSource.InlineResponse2002OrderInformationShipTo);
    });
