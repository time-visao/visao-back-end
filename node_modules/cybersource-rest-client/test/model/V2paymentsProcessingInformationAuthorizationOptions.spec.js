...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V2paymentsProcessingInformationAuthorizationOptions();
  });
  ...
  describe('V2paymentsProcessingInformationAuthorizationOptions', function() {
    it('should create an instance of V2paymentsProcessingInformationAuthorizationOptions', function() {
      // uncomment below and update the code to test V2paymentsProcessingInformationAuthorizationOptions
      //var instane = new CyberSource.V2paymentsProcessingInformationAuthorizationOptions();
      //expect(instance).to.be.a(CyberSource.V2paymentsProcessingInformationAuthorizationOptions);
    });
