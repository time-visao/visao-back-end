...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V2paymentsPaymentInformation();
  });
  ...
  describe('V2paymentsPaymentInformation', function() {
    it('should create an instance of V2paymentsPaymentInformation', function() {
      // uncomment below and update the code to test V2paymentsPaymentInformation
      //var instane = new CyberSource.V2paymentsPaymentInformation();
      //expect(instance).to.be.a(CyberSource.V2paymentsPaymentInformation);
    });
