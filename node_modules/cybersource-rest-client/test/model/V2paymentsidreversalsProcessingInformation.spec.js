...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V2paymentsidreversalsProcessingInformation();
  });
  ...
  describe('V2paymentsidreversalsProcessingInformation', function() {
    it('should create an instance of V2paymentsidreversalsProcessingInformation', function() {
      // uncomment below and update the code to test V2paymentsidreversalsProcessingInformation
      //var instane = new CyberSource.V2paymentsidreversalsProcessingInformation();
      //expect(instance).to.be.a(CyberSource.V2paymentsidreversalsProcessingInformation);
    });
