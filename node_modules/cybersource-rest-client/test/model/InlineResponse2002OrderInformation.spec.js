...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse2002OrderInformation();
  });
  ...
  describe('InlineResponse2002OrderInformation', function() {
    it('should create an instance of InlineResponse2002OrderInformation', function() {
      // uncomment below and update the code to test InlineResponse2002OrderInformation
      //var instane = new CyberSource.InlineResponse2002OrderInformation();
      //expect(instance).to.be.a(CyberSource.InlineResponse2002OrderInformation);
    });
