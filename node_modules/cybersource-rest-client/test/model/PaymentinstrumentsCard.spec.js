...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PaymentinstrumentsCard();
  });
  ...
  describe('PaymentinstrumentsCard', function() {
    it('should create an instance of PaymentinstrumentsCard', function() {
      // uncomment below and update the code to test PaymentinstrumentsCard
      //var instane = new CyberSource.PaymentinstrumentsCard();
      //expect(instance).to.be.a(CyberSource.PaymentinstrumentsCard);
    });
