...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V2paymentsBuyerInformation();
  });
  ...
  describe('V2paymentsBuyerInformation', function() {
    it('should create an instance of V2paymentsBuyerInformation', function() {
      // uncomment below and update the code to test V2paymentsBuyerInformation
      //var instane = new CyberSource.V2paymentsBuyerInformation();
      //expect(instance).to.be.a(CyberSource.V2paymentsBuyerInformation);
    });
