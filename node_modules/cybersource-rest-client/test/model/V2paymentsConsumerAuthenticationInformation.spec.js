...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V2paymentsConsumerAuthenticationInformation();
  });
  ...
  describe('V2paymentsConsumerAuthenticationInformation', function() {
    it('should create an instance of V2paymentsConsumerAuthenticationInformation', function() {
      // uncomment below and update the code to test V2paymentsConsumerAuthenticationInformation
      //var instane = new CyberSource.V2paymentsConsumerAuthenticationInformation();
      //expect(instance).to.be.a(CyberSource.V2paymentsConsumerAuthenticationInformation);
    });
