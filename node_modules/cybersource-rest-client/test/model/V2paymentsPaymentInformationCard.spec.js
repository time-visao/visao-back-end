...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V2paymentsPaymentInformationCard();
  });
  ...
  describe('V2paymentsPaymentInformationCard', function() {
    it('should create an instance of V2paymentsPaymentInformationCard', function() {
      // uncomment below and update the code to test V2paymentsPaymentInformationCard
      //var instane = new CyberSource.V2paymentsPaymentInformationCard();
      //expect(instance).to.be.a(CyberSource.V2paymentsPaymentInformationCard);
    });
