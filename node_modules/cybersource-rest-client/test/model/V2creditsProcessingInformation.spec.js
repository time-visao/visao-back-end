...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V2creditsProcessingInformation();
  });
  ...
  describe('V2creditsProcessingInformation', function() {
    it('should create an instance of V2creditsProcessingInformation', function() {
      // uncomment below and update the code to test V2creditsProcessingInformation
      //var instane = new CyberSource.V2creditsProcessingInformation();
      //expect(instance).to.be.a(CyberSource.V2creditsProcessingInformation);
    });
