...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V2paymentsidcapturesOrderInformationAmountDetails();
  });
  ...
  describe('V2paymentsidcapturesOrderInformationAmountDetails', function() {
    it('should create an instance of V2paymentsidcapturesOrderInformationAmountDetails', function() {
      // uncomment below and update the code to test V2paymentsidcapturesOrderInformationAmountDetails
      //var instane = new CyberSource.V2paymentsidcapturesOrderInformationAmountDetails();
      //expect(instance).to.be.a(CyberSource.V2paymentsidcapturesOrderInformationAmountDetails);
    });
