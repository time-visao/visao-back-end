...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.PaymentinstrumentsBillTo();
  });
  ...
  describe('PaymentinstrumentsBillTo', function() {
    it('should create an instance of PaymentinstrumentsBillTo', function() {
      // uncomment below and update the code to test PaymentinstrumentsBillTo
      //var instane = new CyberSource.PaymentinstrumentsBillTo();
      //expect(instance).to.be.a(CyberSource.PaymentinstrumentsBillTo);
    });
