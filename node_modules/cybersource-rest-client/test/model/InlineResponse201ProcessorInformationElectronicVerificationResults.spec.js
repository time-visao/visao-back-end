...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse201ProcessorInformationElectronicVerificationResults();
  });
  ...
  describe('InlineResponse201ProcessorInformationElectronicVerificationResults', function() {
    it('should create an instance of InlineResponse201ProcessorInformationElectronicVerificationResults', function() {
      // uncomment below and update the code to test InlineResponse201ProcessorInformationElectronicVerificationResults
      //var instane = new CyberSource.InlineResponse201ProcessorInformationElectronicVerificationResults();
      //expect(instance).to.be.a(CyberSource.InlineResponse201ProcessorInformationElectronicVerificationResults);
    });
