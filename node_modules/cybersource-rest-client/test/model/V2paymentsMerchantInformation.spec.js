...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V2paymentsMerchantInformation();
  });
  ...
  describe('V2paymentsMerchantInformation', function() {
    it('should create an instance of V2paymentsMerchantInformation', function() {
      // uncomment below and update the code to test V2paymentsMerchantInformation
      //var instane = new CyberSource.V2paymentsMerchantInformation();
      //expect(instance).to.be.a(CyberSource.V2paymentsMerchantInformation);
    });
