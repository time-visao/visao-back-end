...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V2paymentsidcapturesOrderInformationBillTo();
  });
  ...
  describe('V2paymentsidcapturesOrderInformationBillTo', function() {
    it('should create an instance of V2paymentsidcapturesOrderInformationBillTo', function() {
      // uncomment below and update the code to test V2paymentsidcapturesOrderInformationBillTo
      //var instane = new CyberSource.V2paymentsidcapturesOrderInformationBillTo();
      //expect(instance).to.be.a(CyberSource.V2paymentsidcapturesOrderInformationBillTo);
    });
