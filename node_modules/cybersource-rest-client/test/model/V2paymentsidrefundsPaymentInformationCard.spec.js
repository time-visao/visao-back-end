...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V2paymentsidrefundsPaymentInformationCard();
  });
  ...
  describe('V2paymentsidrefundsPaymentInformationCard', function() {
    it('should create an instance of V2paymentsidrefundsPaymentInformationCard', function() {
      // uncomment below and update the code to test V2paymentsidrefundsPaymentInformationCard
      //var instane = new CyberSource.V2paymentsidrefundsPaymentInformationCard();
      //expect(instance).to.be.a(CyberSource.V2paymentsidrefundsPaymentInformationCard);
    });
