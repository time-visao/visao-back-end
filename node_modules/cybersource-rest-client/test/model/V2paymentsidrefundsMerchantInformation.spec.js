...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V2paymentsidrefundsMerchantInformation();
  });
  ...
  describe('V2paymentsidrefundsMerchantInformation', function() {
    it('should create an instance of V2paymentsidrefundsMerchantInformation', function() {
      // uncomment below and update the code to test V2paymentsidrefundsMerchantInformation
      //var instane = new CyberSource.V2paymentsidrefundsMerchantInformation();
      //expect(instance).to.be.a(CyberSource.V2paymentsidrefundsMerchantInformation);
    });
