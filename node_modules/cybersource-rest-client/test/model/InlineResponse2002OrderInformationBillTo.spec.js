...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse2002OrderInformationBillTo();
  });
  ...
  describe('InlineResponse2002OrderInformationBillTo', function() {
    it('should create an instance of InlineResponse2002OrderInformationBillTo', function() {
      // uncomment below and update the code to test InlineResponse2002OrderInformationBillTo
      //var instane = new CyberSource.InlineResponse2002OrderInformationBillTo();
      //expect(instance).to.be.a(CyberSource.InlineResponse2002OrderInformationBillTo);
    });
