...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.InlineResponse201PaymentInformationTokenizedCard();
  });
  ...
  describe('InlineResponse201PaymentInformationTokenizedCard', function() {
    it('should create an instance of InlineResponse201PaymentInformationTokenizedCard', function() {
      // uncomment below and update the code to test InlineResponse201PaymentInformationTokenizedCard
      //var instane = new CyberSource.InlineResponse201PaymentInformationTokenizedCard();
      //expect(instance).to.be.a(CyberSource.InlineResponse201PaymentInformationTokenizedCard);
    });
