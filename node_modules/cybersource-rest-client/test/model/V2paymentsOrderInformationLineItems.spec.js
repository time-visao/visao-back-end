...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V2paymentsOrderInformationLineItems();
  });
  ...
  describe('V2paymentsOrderInformationLineItems', function() {
    it('should create an instance of V2paymentsOrderInformationLineItems', function() {
      // uncomment below and update the code to test V2paymentsOrderInformationLineItems
      //var instane = new CyberSource.V2paymentsOrderInformationLineItems();
      //expect(instance).to.be.a(CyberSource.V2paymentsOrderInformationLineItems);
    });
