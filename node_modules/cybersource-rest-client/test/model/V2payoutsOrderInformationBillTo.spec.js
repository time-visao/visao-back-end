...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V2payoutsOrderInformationBillTo();
  });
  ...
  describe('V2payoutsOrderInformationBillTo', function() {
    it('should create an instance of V2payoutsOrderInformationBillTo', function() {
      // uncomment below and update the code to test V2payoutsOrderInformationBillTo
      //var instane = new CyberSource.V2payoutsOrderInformationBillTo();
      //expect(instance).to.be.a(CyberSource.V2payoutsOrderInformationBillTo);
    });
