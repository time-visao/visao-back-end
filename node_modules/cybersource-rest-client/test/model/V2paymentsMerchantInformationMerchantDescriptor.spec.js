...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V2paymentsMerchantInformationMerchantDescriptor();
  });
  ...
  describe('V2paymentsMerchantInformationMerchantDescriptor', function() {
    it('should create an instance of V2paymentsMerchantInformationMerchantDescriptor', function() {
      // uncomment below and update the code to test V2paymentsMerchantInformationMerchantDescriptor
      //var instane = new CyberSource.V2paymentsMerchantInformationMerchantDescriptor();
      //expect(instance).to.be.a(CyberSource.V2paymentsMerchantInformationMerchantDescriptor);
    });
