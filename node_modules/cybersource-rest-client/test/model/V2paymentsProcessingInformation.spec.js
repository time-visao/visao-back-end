...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V2paymentsProcessingInformation();
  });
  ...
  describe('V2paymentsProcessingInformation', function() {
    it('should create an instance of V2paymentsProcessingInformation', function() {
      // uncomment below and update the code to test V2paymentsProcessingInformation
      //var instane = new CyberSource.V2paymentsProcessingInformation();
      //expect(instance).to.be.a(CyberSource.V2paymentsProcessingInformation);
    });
