...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CyberSource.V2paymentsOrderInformationBillTo();
  });
  ...
  describe('V2paymentsOrderInformationBillTo', function() {
    it('should create an instance of V2paymentsOrderInformationBillTo', function() {
      // uncomment below and update the code to test V2paymentsOrderInformationBillTo
      //var instane = new CyberSource.V2paymentsOrderInformationBillTo();
      //expect(instance).to.be.a(CyberSource.V2paymentsOrderInformationBillTo);
    });
